...
class NetworkAnalyser:
    ...
    def __init__(self, cal_filename, host, port=5025, BUFF_SIZE=1, center=502, span=5000, n_points=4001, bandwidth=1.0, power=0.0, average=10, measurement="S11" ):#Initialize object. Socket, adress, everything for start work
